...
define('DB_SERVER',			$db['connections']['mysql']['host']				); // Database host
define('DB_PORT',			"3306"											); // Database port
define('DB_USERNAME',		$db['connections']['mysql']['username']			); // Database username
define('DB_PASSWORD',		$db['connections']['mysql']['password']			); // Database password
define('DB_NAME',			$db['connections']['mysql']['database']			); // Database name

$table_prefix = $db['connections']['mysql']['prefix'];									// Table prefix(if any)
