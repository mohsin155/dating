        ...
        <div id="main-content">
            <div class="searchhdg">
                ...
                <div class="view">
                    ...
                    <span class="display">1 - {{count($blocks)}} of {{$total}}</span>
                    ...
                    <div class="pagination">
                        ...
                        @else
                        <a href="{{url('users/my-blocks')}}">first</a>
                        <a href="{{url('users/my-blocks').'?page='.($page_no-1)}}">&lt; prev</a>
                        @endif

                        @if((($page_no*$per_page)+count($blocks))>=$total)
                        <span class="inactive">next &gt;</span>
                        <span class="inactive">last</span>
                        @else
                        <a href="{{url('users/my-blocks').'?page='.($page_no+1)}}">next &gt;</a>
                        <a href="{{url('users/my-blocks').'?page='.(ceil($total/$per_page))}}">last</a>
                        @endif
