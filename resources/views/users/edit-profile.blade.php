                  ...
                  <form name="edit-profile" class="form-inline" id="edit-profile" method="post" action="{{url('users/edit-profile')}}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="income">
                            ...
                            <option value="1" @if(!empty($profile_data) && $profile_data->income==1) selected @endif>Less than $25,000 (USD)</option>
                            <option value="2" @if(!empty($profile_data) && $profile_data->income==2) selected @endif>$25,000-$50,000 (USD)</option>
                            <option value="3" @if(!empty($profile_data) && $profile_data->income==3) selected @endif>$50,000-$75,000 (USD)</option>
                            <option value="4" @if(!empty($profile_data) && $profile_data->income==4) selected @endif>$75,000-$100,000 (USD)</option>
                            <option value="5" @if(!empty($profile_data) && $profile_data->income==5) selected @endif>$100,000-$125,000 (USD)</option>
                            <option value="6" @if(!empty($profile_data) && $profile_data->income==6) selected @endif>Over $125,000 (USD)</option>
                        </select>
                    </div>
                    <hr class="seperate-line">
                    <div class="form-group">
